...
class Inquiry(models.Model):
    ...
    # Skills
    language_ids = fields.One2many("adm.inquiry.languages", "inquiry_id",
                                    string="Languages")
    ...
    def create_new_application(self):
        ...
        for language in self.language_ids:
            ...
            ApplicationLanguageEnv = self.env["adm.application.languages"]
        ...
        #===============================================================================================================
            # self.env['mail.thread'].message_post_with_template(template_id=3, res_id=self.id, model="adm.inquiry")
...
class AdmissionInquiryLanguages(models.Model):
    _name = "adm.inquiry.languages"
    
    language_id = fields.Many2one("adm.languages", string="Language")
    language_level_id = fields.Many2one("adm.languages.level", string="Language Level")
